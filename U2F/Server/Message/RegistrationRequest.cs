...
{
	public class RegistrationRequest : IEqualityComparer<RegistrationRequest>
	{
		/**
		...
		*/
		...
		public bool Equals(RegistrationRequest x, RegistrationRequest y)
		{
			if (x == y)
				return true;
			if (y == null)
		...
		public int GetHashCode(RegistrationRequest obj)
		{
			const int prime = 31;
			var result = 1;
